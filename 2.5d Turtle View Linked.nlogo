...
to setup
  ...
  turtle-fun:link-turtles 14  ask turtles [ fd 10 ]

  ;;turtle-fun:find-links
  ...
  view2.5d:turtle-view window-name turtles [ the-turtle -> .25 * ([ xcor] of the-turtle) ]
  wait 1
  view2.5d:set-turtle-stem-color  window-name [ the-turtle -> [color] of the-turtle ]
  view2.5d:set-turtle-stem-thickness window-name .5
