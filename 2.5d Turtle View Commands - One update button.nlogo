...
to setup
  ...
  view2.5d:turtle-view window-name turtles [ the-turtle -> [ xcor] of the-turtle ]
  wait 1
  set-z-scale
...
to set-observer-distance
  view2.5d:set-observer-distance window-name my-observer-distance
end
...
to-report get-observer-pitch
  report observer-pitch
end


to-report get-observer-heading
  report observer-heading
end

to set-z-scale
  view2.5d:set-z-scale window-name my-z-scale
end

to set-stem-thickness
  view2.5d:set-turtle-stem-thickness window-name my-stem-thickness
end

to set-stem-color
  let real-stem-color grey
  if my-stem-color = "red" [ set real-stem-color  red ]
  if my-stem-color = "blue" [ set real-stem-color blue  ]
  if my-stem-color = "green" [ set real-stem-color green ]
  if my-stem-color = "yellow" [ set real-stem-color yellow ]
  ifelse my-stem-color = "turtle-color"
  [ view2.5d:set-turtle-stem-color window-name  [ the-turtle -> [color] of the-turtle ]]
  [ view2.5d:set-turtle-stem-color window-name  [  real-stem-color ] ]
end
...
my-stem-color
my-stem-color
"turtle-color" "red" "green" "blue" "yellow"
4
