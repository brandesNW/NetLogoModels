extensions [ view2.5d  turtle-fun ]
...
to set-stem-color
  ...
  ifelse set-stem-color-from-turtle
  [ view2.5d:set-turtle-stem-color window-name  stem-color-from-turtle ]
  [ view2.5d:set-turtle-stem-color window-name  [  read-from-string my-stem-color ] ]
end
...
to-report stem-color-from-turtle
  set my-stem-color ""
  report [ my-turtle -> [color] of my-turtle ]
end
